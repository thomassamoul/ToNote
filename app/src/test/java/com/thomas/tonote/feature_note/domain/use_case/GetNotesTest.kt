...
import com.thomas.tonote.feature_note.data.repository.FakeNoteRepository
import com.thomas.tonote.feature_note.domain.model.Note
import com.thomas.tonote.feature_note.domain.util.NoteOrder
import com.thomas.tonote.feature_note.domain.util.OrderType
...
class GetNotesTest {
    ...
    fun setUp() {
        ...
        runBlocking {
            notesToInsert.forEach { fakeRepository.insetNote(it) }
        }
