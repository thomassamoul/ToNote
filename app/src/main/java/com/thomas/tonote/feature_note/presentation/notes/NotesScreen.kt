...
import com.thomas.tonote.feature_note.presentation.notes.components.NoteItem
import com.thomas.tonote.feature_note.presentation.notes.components.OrderSection
        ...
        Column(modifier = Modifier
            ...
            Row(
                ...
                IconButton(onClick = {
                    ...
                    Icon(imageVector = Icons.Default.Filter, contentDescription = "Sort")
                }
            }
            AnimatedVisibility(
                ...
                items(state.notes) {
                    NoteItem(
                        ...
                        onDeleteClick = {
                            ...
                            scope.launch {
                                val result =
                                    scaffoldState.snackbarHostState.showSnackbar(message = "Note Deleted",
                                        actionLabel = "Undo")
